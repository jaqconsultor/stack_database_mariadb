...
{ "ER_TABLE_NEEDS_REBUILD", 1707, "Table rebuild required. Please do \"ALTER TABLE `%-.32T` FORCE\" or dump/reload to fix it!" },
...
{ "ER_DUP_QUERY_NAME", 4004, "Duplicate query name in WITH clause \'%s\'" },
...
{ "ER_TRANSACTIONAL_ARIA_LOG_ENGINE", 4078, "Only non-transactional Aria table can be used for logging" },
